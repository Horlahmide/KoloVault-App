...
export type RateLimitWhereInput = {
  ...
  lastAttempt?: Prisma.DateTimeFilter<"RateLimit"> | Date | string
}
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  lastAttempt?: Prisma.DateTimeWithAggregatesFilter<"RateLimit"> | Date | string
}
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "count" | "lastAttempt", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitFieldRefs {
  ...
  readonly lastAttempt: Prisma.FieldRef<"RateLimit", 'DateTime'>
}
